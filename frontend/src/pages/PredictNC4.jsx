...
export default function PredictNC4(){
  ...
  return (
    <div className="p-6 max-w-lg mx-auto">
      <h1 className="text-3xl font-bold mb-5">NC4 Prediction</h1>
      <input className="border p-2 mb-3 w-full" placeholder="Model Name" onChange={(e)=>setModelName(e.target.value)} />
      <input type="file" onChange={(e)=>setFile(e.target.files[0])} className="mb-4" />
      <button onClick={handlePredict} className="bg-purple-500 text-white px-4 py-2 rounded">Predict NC4</button>
