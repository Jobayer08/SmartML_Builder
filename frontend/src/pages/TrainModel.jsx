        ...
        <div className="bg-gradient-to-br from-white to-blue-50/50 rounded-xl shadow-md border border-blue-200 overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <input 
                className="w-full px-4 py-2 border border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                placeholder="e.g., house_price_model, sales_predictor" 
                value={modelName} 
                onChange={e => setModelName(e.target.value)} 
              />
              <p className="text-xs text-blue-500 mt-1">
                💡 Optional. Default: "my_model"
              </p>
            </div>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="bg-green-50 p-3 rounded-lg">
                  ...
                  <p className="text-gray-800 font-medium">{result.model_name || modelName || 'my_model'}</p>
                </div>
                <div className="bg-green-50 p-3 rounded-lg">
                  <p className="text-xs text-green-600 font-semibold">Target Column</p>
              ...
              {result.problem_type && (
                <div className="bg-green-50 p-3 rounded-lg mb-4">
                  ...
                  <p className="text-gray-800 font-medium">{result.problem_type}</p>
                </div>
              )}
              ...
              <div className="bg-green-50 p-3 rounded-lg">
                ...
                <pre className="bg-white p-3 rounded-lg text-xs overflow-auto max-h-60 border border-green-200">
